...
namespace MoneyOrbit.Application.Interfaces.IApplication.IFactories
{
    ...
    {
        /// <summary>
        /// Creates a new User with the default specified parameters. It should generate the id for the user
        /// </summary>
        ...
        User CreateUser(string _userName, string _firstName, string _lastName, string _password);
    }
}
